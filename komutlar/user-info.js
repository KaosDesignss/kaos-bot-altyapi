...
exports.run = (client, message, params) => {
  ...
  if (message.channel.type !== "group") {
      ...
      .setFooter('GrowArtist, iyi eğlenceler diler!', client.user.avatarURL)
      console.log("a!user-info komutu " + message.author.username + " tarafından istendi.")
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['kullanıcı-bilgi', 'u-info', 'userinfo'],
  permLevel: 0
};
